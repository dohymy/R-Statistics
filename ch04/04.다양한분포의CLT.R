...
c(mean(t2.mean), sd(t2.mean))   # -0.04585  0.93745
c(mean(t4.mean), sd(t4.mean))   # 0.001526 0.631027
c(mean(t16.mean), sd(t16.mean)) # -0.002464  0.306708
c(mean(t32.mean), sd(t32.mean)) # 0.003597 0.229231
